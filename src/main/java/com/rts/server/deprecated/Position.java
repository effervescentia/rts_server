...
public class Position {
	...
	public boolean equals(Object other) {
		if (other instanceof Position) {
			...
			return ((this.x == otherPosition.y || (this.x != null
					&& otherPosition.x != null && this.x
						.equals(otherPosition.x))) && (this.y == otherPosition.y || (this.y != null
					&& otherPosition.y != null && this.y
						.equals(otherPosition.y))));
		}
